...
treehouse.start = function(){
    ...
    //add one task to the schedule manager: check if frog is moving
...
treehouse.createWalls= function(){
    var t=30; //thickness.  Can easily change size of wall
    var walls = [];
    var wallCoordinates= [
        [0,0, 35*t, t],
        [0,0, t, 26*t],
    ...
    for (i=0; i<wallCoordinates.length; i++){
